...
namespace Offsets
{
	constexpr int32 GObjects          = 0x042BEC70;
	constexpr int32 AppendString      = 0x00ED9390;
	constexpr int32 GNames            = 0x04282980;
	constexpr int32 GWorld            = 0x04401D78;
	constexpr int32 ProcessEvent      = 0x010D10F0;
